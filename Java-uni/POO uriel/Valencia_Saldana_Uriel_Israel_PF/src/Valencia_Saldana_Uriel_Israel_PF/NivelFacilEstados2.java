...
public class NivelFacilEstados2 extends JFrame {
    ...
    private JLabel pregunta;
        ...
        public NivelFacilEstados2(){
        super("Nivel Facil Pregunta 2");
        JLabel NL_png = new JLabel(new ImageIcon("nuevoleon.png")); //Imagen
        PanelBotones = new JPanel();
        botones = new JButton[4];
        PanelBotones.setLayout(new GridLayout(2, botones.length));
        PanelImagen = new JPanel();
        PanelImagen.add(NL_png); //Modificar en todo lo demas
        
        //Pregunta       
        pregunta = new JLabel("¿Cuál la capital del estado de Nuevo Leon?");
        ...
        boton2 = new JButton("San Nicolas de los Garza");
        boton3 = new JButton("Monterrey");
        ...
        ActionListener accion3 = new ActionListener(){
            @Override
            public void actionPerformed(ActionEvent AE) {
               JOptionPane.showMessageDialog(null,"Respuesta Correcta, Ganaste el Nivel Facil!");
