...
public class NivelDificilEstados2 extends JFrame{
    ...
    private JLabel pregunta;
        ...
        public NivelDificilEstados2(){
        super("Nivel Medio Pregunta 2");
        JLabel bajasur_png = new JLabel(new ImageIcon("bajasur.png")); //Imagen
        PanelBotones = new JPanel();
        botones = new JButton[4];
        PanelBotones.setLayout(new GridLayout(2, botones.length));
        PanelImagen = new JPanel();
        PanelImagen.add(bajasur_png); //Modificar en todo lo demas
        
        //Pregunta       
        pregunta = new JLabel("¿Cuál la capital del estado de Baja California Sur?");
        ...
        //Crear Botones
        boton1 = new JButton("La Paz");
        boton2 = new JButton("Cabo San Lucas");
        boton3 = new JButton("Loreto");
        ...
        ActionListener accion1 = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent AE) {
                JOptionPane.showMessageDialog(null,"Respuesta Correcta, Ganaste el Nivel Dificil!");
