...
public class NivelDificilEstados extends JFrame{
    ...
    private JLabel pregunta;
        ...
        public NivelDificilEstados(){
        super("Nivel Dificil Pregunta 1");
        JLabel guerrero_png = new JLabel(new ImageIcon("guerrero.png")); //Imagen
        PanelBotones = new JPanel();
        botones = new JButton[4];
        PanelBotones.setLayout(new GridLayout(2, botones.length));
        PanelImagen = new JPanel();
        PanelImagen.add(guerrero_png); //Modificar en todo lo demas
        
        //Pregunta       
        pregunta = new JLabel("¿Cuál la capital del estado de Guerrero");
        ...
        //Crear Botones
        boton1 = new JButton("Acapulco");
        boton2 = new JButton("Iguala");
        boton3 = new JButton("Chilpancingo");
        ...
        ActionListener accion3 = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent AE) {
                ...
                NivelDificilEstados2 accion3 = new NivelDificilEstados2();
                accion3.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                accion3.setBounds(270, 150, 800, 500);
