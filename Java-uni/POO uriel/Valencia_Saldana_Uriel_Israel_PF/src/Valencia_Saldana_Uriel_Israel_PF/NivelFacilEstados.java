...
public class NivelFacilEstados extends JFrame {
    ...
    private JLabel pregunta;
        ...
        public NivelFacilEstados(){
        super("Nivel Facil Pregunta 1");
        JLabel Jalisco_png = new JLabel(new ImageIcon("jalisco.png")); //Imagen
        PanelBotones = new JPanel();
        botones = new JButton[4];
        PanelBotones.setLayout(new GridLayout(2, botones.length));
        PanelImagen = new JPanel();
        PanelImagen.add(Jalisco_png); //Modificar en todo lo demas
        
        //Pregunta       
        pregunta = new JLabel("¿Cuál la capital del estado de Jalisco?");
        ...
        //Crear Botones
        boton1 = new JButton("Zapopan");
        boton2 = new JButton("Guadalajara");
        boton3 = new JButton("Tlaquepaque");
        ...
        ActionListener accion2 = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent AE) {
               ...
               NivelFacilEstados2 accion2 = new NivelFacilEstados2();
