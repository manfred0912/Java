...
public class PaisesOceania2 extends JFrame {
    ...
    private JLabel pregunta;
        ...
        public PaisesOceania2(){
        super("Pais Continente Europa 2");
        JLabel nz = new JLabel(new ImageIcon("nz.png")); //Imagen
        PanelBotones = new JPanel();
        botones = new JButton[4];
        PanelBotones.setLayout(new GridLayout(2, botones.length));
        PanelImagen = new JPanel();
        PanelImagen.add(nz); //Modificar en todo lo demas
        
        //Pregunta       
        pregunta = new JLabel("¿Cuál la Capital de Nueva Zelanda");
        ...
        //Crear Botones
        boton1 = new JButton("Wellington");
        boton2 = new JButton("Auckland");
        boton3 = new JButton("Queenstown");
        ...
        ActionListener accion1 = new ActionListener(){
            ...
            public void actionPerformed(ActionEvent AE) {
                ...
                PaisesOceania3 accion1 = new PaisesOceania3();
                accion1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
                accion1.setBounds(320, 10, 730, 750);
